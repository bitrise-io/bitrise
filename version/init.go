...
// Injected at build time via -ldflags "-X github.com/bitrise-io/bitrise/v3/version.VERSION=..."
...
// Injected at build time via -ldflags "-X github.com/bitrise-io/bitrise/v3/version.BuildNumber=..."
var BuildNumber = ""

// Commit is the git commit hash used for building the release.
// Injected at build time via -ldflags "-X github.com/bitrise-io/bitrise/v3/version.Commit=..."
var Commit = ""
