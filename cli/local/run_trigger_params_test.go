...
func TestParseRunAndTriggerJSONParams(t *testing.T) {
	t.Log("it parses cli params")
	{
		paramsMap := map[string]interface{}{
			cmdutil.WorkflowKey: "primary",

			cmdutil.PatternKey:        "master",
			cmdutil.PushBranchKey:     "deploy",
			cmdutil.PRSourceBranchKey: "development",
			cmdutil.PRTargetBranchKey: "release",
			...
			cmdutil.InventoryKey:       ".secrets.bitrise.yml",
			cmdutil.InventoryBase64Key: toBase64(".secrets.bitrise.yml"),
		}
...
func TestParseRunAndTriggerParams(t *testing.T) {
	...
	t.Log("it parses json params")
	{
		...
		paramsMap := map[string]interface{}{
			cmdutil.WorkflowKey: workflow,

			cmdutil.PatternKey:        pattern,
			cmdutil.PushBranchKey:     pushBranch,
			cmdutil.PRSourceBranchKey: prSourceBranch,
			...
			cmdutil.InventoryKey:       inventoryPath,
			cmdutil.InventoryBase64Key: inventoryBase64Data,
		}
