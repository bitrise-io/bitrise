...
2. Release a new versions of default plugins if there are changes, you can find the default plugins in `./bitrise/setup.go`:
...
3. Update go dependencies (`bitrise run godeps-update`)
