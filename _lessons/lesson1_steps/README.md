...
Now that you created your first local project (by calling the `bitrise local setup` and after it the `bitrise local init`) we can have some fun with the Steps! Open the bitrise.yml and let's add some steps!
