...
type ToolConfigModel struct {
	...
	// ExperimentalDisableFastInstall disables the use of nixpkgs backend for faster tool installation (currently Ruby only).
	ExperimentalDisableFastInstall bool `json:"experimental_disable_fast_install,omitempty" yaml:"experimental_disable_fast_install,omitempty"`
}
