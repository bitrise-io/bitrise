...
```txt
https://github.com/bitrise-io/bitrise/models/bitrise-data-model#/$defs/GraphPipelineWorkflowListItemModel
```
...
## GraphPipelineWorkflowListItemModel Type

`object` ([Details](bitrise-defs-graphpipelineworkflowlistitemmodel.md))

# GraphPipelineWorkflowListItemModel Properties
